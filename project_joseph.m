...
%
%  DESCRIPTION:
%     Sequential processor using the Joseph-form covariance measurement
%     update for the MAE 182 project.
%
...
if S.makePlots
    ...
    title( 'Joseph Position Error Ellipsoid (3-sigma, final epoch)' );
    xlabel( 'x [m]' ); ylabel( 'y [m]' ); zlabel( 'z [m]' );
end

save project_joseph_results x_hat P_store pre_fit post_fit ...
