...
for k = 1:nObs
    ...
    [ W_upd , x_upd ] = potter_scalar_update( W_upd , x_upd , Htilde(1,:) , innov1 , S.sig_rho^2 );

    innov2 = y_k(2) - Htilde(2,:) * x_upd;
    [ W_upd , x_upd ] = potter_scalar_update( W_upd , x_upd , Htilde(2,:) , innov2 , S.sig_rhodot^2 );
...
if S.makePlots
    ...
    title( 'Potter Position Error Ellipsoid (final epoch)' );
